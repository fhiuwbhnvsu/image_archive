...
def set():
    ...
    parser.add_argument("--load_fh",        type=str,   default=None,     help="load the checkpoints of fh")
    parser.add_argument("--load_lh",        type=str,   default=None,     help="load the checkpoints of lh")
    ...
    parser.add_argument("--sde_var",        type=float, default=1.0,      help="g(t)")
    ...
    # ---------------- evaluation ----------------
    parser.add_argument("--data_type",      type=str,   default="train",  help="Dataset type")
    ...
    parser.add_argument("--compute-EMD",    action="store_true",          help="flag: evaluate EMD")
    parser.add_argument("--compute-CDD",    action="store_true",          help="flag: evaluate CDD")
    ...
    default_config, model_configs = {
        ...
        'rna-5': configs.get_rna5_default_configs,
        'rna-10': configs.get_rna10_default_configs,
        'rna-20': configs.get_rna20_default_configs,
        'rna-5-lmt': configs.get_rna5_lmt_default_configs
    }.get(problem_name)()
    ...
    if opt.compute_CDD or opt.compute_EMD or opt.compute_NLL or opt.compute_FID:
